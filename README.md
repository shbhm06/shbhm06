...
Hardware CNN inference accelerator for MNIST digit classification, implemented in Verilog.

</td>
<td width="50%">

**[Async FIFO (CDC-safe)](https://github.com/shbhm06/async_fifo)**
Asynchronous FIFO built using Cummings' 2002 clock-domain-crossing methodology — N+1-bit gray-coded pointers with SystemVerilog assertions for correctness.
